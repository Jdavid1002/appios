...
import {update as updateAction} from '../../reducers/simulacrum/actions';
import {get as getDailyQuestionAction} from '../../reducers/daily-question/actions';
...
class SimulacrumService {
  ...
  public getFilterLevels = async (_params?: IFilterLevelsSimulacrumsParams) => {
    let responseData: any;
    const alliance_id = _params?.alliance_id
      ? _params.alliance_id
      : this.alliance;
