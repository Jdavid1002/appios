...
import ChallengeCard from 'app_components/modules/challenge-card/components/challenge-card-simple';
...
class ChallengesContainer extends Component<any> {
  ...
  handlePress = (matterId: number) => {
    const matter_data: any = this.state.matters.find((m: any) => m.id === matterId);
    if(!matter_data) return
