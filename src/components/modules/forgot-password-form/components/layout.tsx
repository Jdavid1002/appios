...
import { Platform, StatusBar, TextInput, View, TouchableOpacity } from 'react-native';
  ...
  render() {
    ...
    return (
      <View style={mainStyles.formContainer}>
        ...
        <TouchableOpacity onPress={this.props.handleSubmit} style={[mainStyles.formButton, styles.button]}>
          <CustomText style={[mainStyles.textCenter, mainStyles.formButtonText, styles.buttonText]}>Restablecer</CustomText>
        </TouchableOpacity>
      </View>
    );
  }
